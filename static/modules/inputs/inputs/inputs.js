...
class Inputer {
    ...
    _createWrapper(element) {
        this.element = new DOMParser().parseFromString(`
            <div class="inputs-input">
                <div class="inputs-input__wrapper">
                </div>
            </div>
        ...
        this.inputWrapper = this.element.querySelector(".inputs-input__wrapper");
    ...
    _addListeners() {
        this.inputWrapper.addEventListener("click", this._inputClickEvent);
    }
